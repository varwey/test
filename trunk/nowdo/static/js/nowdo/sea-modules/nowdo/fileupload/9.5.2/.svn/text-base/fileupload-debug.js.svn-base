define("nowdo/fileupload/9.5.2/fileupload", [ "$", "nowdo/jquery-ui/1.10.4/jquery-ui" ], function(require, exports, module) {
    var jQuery = require("$");
    require("nowdo/jquery-ui/1.10.4/jquery-ui");
    (function($) {
        "use strict";
        ...
        $.widget("blueimp.fileupload", {
            ...
            _initXHRData: function(options) {
                var that = this, formData, file = options.files[0], // Ignore non-multipart setting if not supported:
            ...
            _initDataAttributes: function() {
                ...
                $.each(clone.data(), function(key, value) {
                    var dataAttributeName = "data-" + // Convert camelCase to hyphen-ated key:
