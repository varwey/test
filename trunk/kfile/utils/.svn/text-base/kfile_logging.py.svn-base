...
# logger = Logging.getLogger('kfile', log_level=setting.LOG_LEVEL, log_file=setting.LOG_FILE)
# celery_logger = Logging.getLogger('kfile_celery', log_level=setting.CELERY_LOG_LEVEL, log_file=setting.CELERY_LOG_FILE)
#init in call
logger = None
celery_logger = None
